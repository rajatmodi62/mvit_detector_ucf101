...
# Path from where the checkpoint is to be loaded 
_C.MVIT.CHECKPOINT_PATH = ''
# -----------------------------------------------------------------------------
...
_C.PROJECT_NAME = 'noprojectfound'
...
_C.DATA_LOADER.TRAIN_BATCH_SIZE = 1

_C.DATA_LOADER.TEST_BATCH_SIZE = 1
# -----------------------------------------------------------------------------
# AVA Dataset options
# -----------------------------------------------------------------------------
_C.AVA = CfgNode()
